...
/// Precomputed: keccak256("Order(bytes32 orderChainToken,bytes32 adChainToken,uint256 amount,bytes32 bridger,uint256 orderChainId,bytes32 orderPortal,bytes32 orderRecipient,uint256 adChainId,bytes32 adManager,string adId,bytes32 adCreator,bytes32 adRecipient,uint256 salt)")
pub const ORDER_TYPEHASH: [u8; 32] = [
    0x1c, 0xa8, 0x76, 0x1e, 0xd9, 0xca, 0x27, 0xde, 0x27, 0x66, 0xec, 0x2a, 0x57, 0x67, 0xed, 0xf8,
    0x23, 0x1a, 0xb9, 0x0b, 0xcd, 0x98, 0x80, 0x58, 0xbc, 0x64, 0xb2, 0x96, 0x64, 0x94, 0xfe, 0x9b,
];
