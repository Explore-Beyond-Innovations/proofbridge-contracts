...
// ultrahonk ZK verify). Measured baseline plus headroom; the metered unlock runs
// under reset_unlimited() so it can exceed the default 100M CPU per-tx budget.
const AD_UNLOCK_CPU_CEILING: u64 = 122_000_000;
const AD_UNLOCK_MEM_CEILING: u64 = 8_100_000;
const OP_UNLOCK_CPU_CEILING: u64 = 122_000_000;
const OP_UNLOCK_MEM_CEILING: u64 = 8_100_000;
